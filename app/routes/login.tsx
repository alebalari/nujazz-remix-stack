				...
				<div className='grid lg:h-screen lg:grid-cols-2'>
					<div className='flex items-center justify-center py-6 px-4 sm:px-0 lg:py-0'>
						<Form
							...
							<div className='items-center space-y-3 space-x-0'>
								<Link
									to='/'
							...
							<button
								type='submit'
								className='w-full rounded-lg bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-700'>
					...
					<div className='flex items-center justify-center bg-primary-600 py-6 px-4 sm:px-0 lg:py-0'>
						<div className='max-w-md xl:max-w-xl'>
							...
							<p className='mb-4 font-light text-primary-200 lg:mb-8'>
								Millions of designers and agencies around the world showcase their portfolio work on Flowbite - the home
								to the world’s best design and creative professionals.
							</p>
